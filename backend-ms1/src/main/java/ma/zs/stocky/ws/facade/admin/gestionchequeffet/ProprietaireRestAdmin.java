...
import ma.zs.stocky.ws.converter.gestionchequeffet.ProprietaireConverter;
...
public class ProprietaireRestAdmin  extends AbstractController<Proprietaire, ProprietaireDto, ProprietaireCriteria, ProprietaireAdminService, ProprietaireConverter> {
    ...
    @Operation(summary = "Finds a proprietaire by nom")
    @GetMapping("nom/{nom}")
    public ResponseEntity<ProprietaireDto> findByNom(@PathVariable String nom, String[] includes, String[] excludes) throws Exception {
        return super.findByReferenceEntity(new Proprietaire(nom), includes, excludes);
    }
