...
public class ClientRestAdmin  extends AbstractController<Client, ClientDto, ClientCriteria, ClientAdminService, ClientConverter> {
    ...
    @GetMapping("cin/{cin}")
    public ResponseEntity<ClientDto> findByCin(@PathVariable String cin, String[] includes, String[] excludes) throws Exception {
        return super.findByReferenceEntity(new Client(cin), includes, excludes);
    }
