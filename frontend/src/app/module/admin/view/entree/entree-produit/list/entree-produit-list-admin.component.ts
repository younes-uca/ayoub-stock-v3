...
export class EntreeProduitListAdminComponent extends AbstractListController<EntreeProduitDto, EntreeProduitCriteria, EntreeProduitAdminService>  implements OnInit {
    ...
    constructor( private entreeProduitService: EntreeProduitAdminService  , private depotService: DepotAdminService, private produitService: ProduitAdminService, private entreeProduitItemService: EntreeProduitItemAdminService, private fournisseurService: FournisseurAdminService) {
