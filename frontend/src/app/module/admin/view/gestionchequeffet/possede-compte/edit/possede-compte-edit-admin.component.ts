...
@Component({
  selector: 'app-possede-compte-edit-admin',
  templateUrl: './possede-compte-edit-admin.component.html'
})
export class PossedeCompteEditAdminComponent extends AbstractEditController<PossedeCompteDto, PossedeCompteCriteria, PossedeCompteAdminService>   implements OnInit {
