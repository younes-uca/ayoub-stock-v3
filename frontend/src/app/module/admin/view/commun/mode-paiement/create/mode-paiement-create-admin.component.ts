...
export class ModePaiementCreateAdminComponent extends AbstractCreateController<ModePaiementDto, ModePaiementCriteria, ModePaiementAdminService>  implements OnInit {
