...
export class PaiementVenteCreateAdminComponent extends AbstractCreateController<PaiementVenteDto, PaiementVenteCriteria, PaiementVenteAdminService>  implements OnInit {
