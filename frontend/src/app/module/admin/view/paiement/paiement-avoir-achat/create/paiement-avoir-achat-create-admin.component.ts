...
@Component({
  selector: 'app-paiement-avoir-achat-create-admin',
  templateUrl: './paiement-avoir-achat-create-admin.component.html'
})
export class PaiementAvoirAchatCreateAdminComponent extends AbstractCreateController<PaiementAvoirAchatDto, PaiementAvoirAchatCriteria, PaiementAvoirAchatAdminService>  implements OnInit {
