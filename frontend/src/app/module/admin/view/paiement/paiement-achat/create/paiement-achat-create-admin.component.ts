...
export class PaiementAchatCreateAdminComponent extends AbstractCreateController<PaiementAchatDto, PaiementAchatCriteria, PaiementAchatAdminService>  implements OnInit {
