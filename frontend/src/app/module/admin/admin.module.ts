...
import { ChequeffetAdminModule } from './view/chequeffet/chequeffet-admin.module';
import { ChequeffetAdminRoutingModule } from './view/chequeffet/chequeffet-admin-routing.module';
...
@NgModule({
  ...
  ChequeffetAdminModule,
  ChequeffetAdminRoutingModule,
  StockAdminModule,
